package Brocken::AST::Node {
    ...
    class Brocken::AST::Node { method dump {'Node'} }
    ...
    class Brocken::AST::VarDecl : isa(Brocken::AST::Node) { field $name : param : reader; field $type : param : reader; field $value : param : reader; }
    class Brocken::AST::StateDecl : isa(Brocken::AST::Node) { field $name : param : reader; field $type : param : reader; field $value : param : reader; }
    ...
    class Brocken::AST::If : isa(Brocken::AST::Node) { field $condition : param : reader; field $then_block : param : reader; field $else_block : param : reader = undef; }
    ...
    class Brocken::AST::Method : isa(Brocken::AST::Node) { field $name : param : reader; field $params : param : reader; field $body : param : reader; }
    ...
    class Brocken::AST::ClassDecl : isa(Brocken::AST::Node) { field $name : param : reader; field $fields : param : reader; field $methods : param : reader; }
    class Brocken::AST::FieldDecl : isa(Brocken::AST::Node) { field $name : param : reader; field $type : param : reader; }
    class Brocken::AST::MethodCall : isa(Brocken::AST::Node) { field $invocant : param : reader; field $name : param : reader; field $args : param : reader; }
};
1;
